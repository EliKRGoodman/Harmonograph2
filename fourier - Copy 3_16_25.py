...
game_states = ({"hue": 0, "hue_step": .0002, "gcd_value": 0, "num_arms": 0, "decay": 0, "screenshot_timer": 0,
                "normal_speed": 5, "new_normal_speed": 5, "normal_length": border-5, "new_normal_length": border-5,

                "running": True, "show_info": True, "show_trail": True, "show_lines":True, "rainbow": True, "show_arms": True, "show_buttons": True, "start": True,
                "add_speed": False, "repeated": False, "reset": False, "random_inputs": False, "pause": False, "back": False, "sound_fx": False,
                "last_click":"left"})

repeat_nums, combined_repeat_nums, arm_list, fractions, button_list = [], [], [], [], [] #trail_list
...
button_functions = ([show_buttons, toggle_sound, toggle_arms, toggle_trail, toggle_color, toggle_lines, toggle_info, #left outer, ascending
                    change_speed, zoom, add_decay, add_rainbow, new_pattern, random_pattern, exit, #right outer
